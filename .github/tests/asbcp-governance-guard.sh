...
require_contains docs/contracts/operations-and-errors.md "Consumer Diagnostics Handoff" "consumer diagnostics handoff section"
require_contains docs/contracts/operations-and-errors.md "request id, workload id or" "sanitized request/workload diagnostics fields"
require_contains docs/contracts/agentsmith-integration-contract.md "AGENT_SANDBOX_UNAVAILABLE" "AgentSmith sandbox-unavailable diagnostics handoff"
require_contains docs/contracts/agentsmith-integration-contract.md "Readiness an ASBCP release gate" "consumer diagnostics non-verdict boundary"
require_contains docs/READINESS_EVIDENCE.md "Consumer diagnostics handoff" "consumer diagnostics readiness evidence row"
require_contains docs/release-evidence/release-manifest.json "\"consumer_diagnostics_handoff\"" "consumer diagnostics release evidence id"
