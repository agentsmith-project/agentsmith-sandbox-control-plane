...
- Fake-fixture smoke for health/ready handlers, workspace binding PVC safety, workload scoped identity, workload create/keepalive/release/delete paths, and exec route/error contract.
